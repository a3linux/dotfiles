...
if [ -d ~/Library/Application\ Support/Microsoft\ Edge ]; then
    msg "Cleaning Microsoft Edge Cache Files..."
    sudo rm -rfv ~/Library/Application\ Support/Microsoft\ Edge/Default/Service\ Worker/CacheStorage/* &>/dev/null
    sudo rm -rfv ~/Library/Application\ Support/Microsoft\ Edge/Default/Service\ Worker/ScriptCache/* &>/dev/null
fi
